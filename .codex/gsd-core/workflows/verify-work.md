...
<template>
@C:/Development/Private/openai-build-week/.codex/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/Development/Private/openai-build-week/.codex/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/Development/Private/openai-build-week/.codex/gsd-core/workflows/transition.md`.
...
- Follow @C:/Development/Private/openai-build-week/.codex/gsd-core/workflows/diagnose-issues.md

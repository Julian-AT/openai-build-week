...
ones). Reference: @C:/Development/Private/openai-build-week/.codex/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / C:/Development/Private/openai-build-week/.codex.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "C:/Development/Private/openai-build-week/.codex/gsd-core/bin/lib/edge-probe.cjs" \
  "C:/Development/Private/openai-build-week/.codex/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @C:/Development/Private/openai-build-week/.codex/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @C:/Development/Private/openai-build-week/.codex/gsd-core/templates/spec.md.

...
INSTALL_JS_GLOBAL="C:/Development/Private/openai-build-week/.codex/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Development/Private/openai-build-week/.codex/gsd-core/bin/install.js --global --<runtime>
```
Then exit.

...
@C:/Development/Private/openai-build-week/.codex/gsd-core/references/git-integration.md
</required_reading>
...
See `C:/Development/Private/openai-build-week/.codex/gsd-core/references/tdd.md` for structure.
</tdd_plan_execution>
...
See C:/Development/Private/openai-build-week/.codex/gsd-core/references/checkpoints.md for details.
</step>
...
Create `{phase}-{plan}-SUMMARY.md` at `.planning/phases/XX-name/`. Use `C:/Development/Private/openai-build-week/.codex/gsd-core/templates/summary.md`.

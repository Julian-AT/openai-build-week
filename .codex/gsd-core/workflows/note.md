...
- **Global scope**: `C:/Development/Private/openai-build-week/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Development/Private/openai-build-week/.codex/notes/`)
...
2. Glob `C:/Development/Private/openai-build-week/.codex/notes/*.md` (if directory exists) — global notes
...
Global (C:/Development/Private/openai-build-week/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Development/Private/openai-build-week/.codex/notes/` — works in any directory

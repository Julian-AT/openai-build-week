...
```markdown
Read C:/Development/Private/openai-build-week/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Development/Private/openai-build-week/.codex/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Development/Private/openai-build-week/.codex/agents/gsd-ui-checker.md for instructions.

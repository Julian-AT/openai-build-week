...
```
Agent(
  prompt="Read C:/Development/Private/openai-build-week/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Development/Private/openai-build-week/.codex/gsd-core/templates/VALIDATION.md`

...
<!-- For checkpoint task examples and patterns, see @C:/Development/Private/openai-build-week/.codex/gsd-core/references/checkpoints.md -->
...
See `C:/Development/Private/openai-build-week/.codex/gsd-core/references/tdd.md` for TDD plan structure.
...
See `C:/Development/Private/openai-build-week/.codex/gsd-core/templates/user-setup.md` for full schema and examples
...
See `C:/Development/Private/openai-build-week/.codex/gsd-core/workflows/verify-phase.md` for verification logic.

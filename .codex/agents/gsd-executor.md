...
@C:/Development/Private/openai-build-week/.codex/gsd-core/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@C:/Development/Private/openai-build-week/.codex/gsd-core/references/ios-scaffold.md
...
@C:/Development/Private/openai-build-week/.codex/gsd-core/references/executor-examples.md
</deviation_rules>
...
**See @C:/Development/Private/openai-build-week/.codex/gsd-core/references/checkpoints.md**
...
**When the orchestrator passes both `MVP_MODE=true` and `TDD_MODE=true`:** Before running the implementation step of any task with `tdd="true"`, run the runtime gate from `C:/Development/Private/openai-build-week/.codex/gsd-core/references/execute-mvp-tdd.md` (Read it). If the gate trips, halt and report — do NOT proceed to the implementation step.
...
**Use template:** @C:/Development/Private/openai-build-week/.codex/gsd-core/templates/summary.md
...
<state_updates>
After SUMMARY.md, update STATE.md using `node "$HOME/.codex/gsd-core/bin/gsd-tools.cjs" query` state handlers (positional args; see `sdk/src/query/QUERY-HANDLERS.md`):

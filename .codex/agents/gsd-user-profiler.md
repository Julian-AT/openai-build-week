...
<reference>
@C:/Development/Private/openai-build-week/.codex/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Development/Private/openai-build-week/.codex/gsd-core/references/user-profiling.md` to load:

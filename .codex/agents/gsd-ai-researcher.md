...
<required_reading>
Read `C:/Development/Private/openai-build-week/.codex/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>

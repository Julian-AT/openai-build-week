...
tools: - Read
purpose: Verifies threat mitigations from PLAN.md threat model exist in implemented code. Produces SECURITY.md. Spawned by $gsd-secure-phase.
</codex_agent_role>
...
**Verification depth scales with `asvs_level`** (see @C:/Development/Private/openai-build-week/.codex/gsd-core/references/security-asvs-levels.md for full definitions):

...
These documentation-grade JSON Schemas are the field and lifecycle authority for later implementations. They are not generated bindings and no product code exists yet.

...
- [ ] 01-01 — Freeze closed fixture/result schemas and immutable contract/JCS/coordinate oracle.
- [ ] 01-02 — Define canonical sanitized gate/checklist evidence, including human-only waiver rules.
...
- [ ] 01-05 — Implement the independent JavaScript contract and coordinate runner.
- [ ] 01-06 — Implement the independent Python contract and coordinate runner.

**Wave 4** *(blocked on Wave 3 completion)*

- [ ] 01-07 — Prove JavaScript/Python parity with cross-runtime mutation gates.
...
- [ ] 01-10 — Execute Swift/JavaScript/Python agreement and record bound evidence.

**Wave 8** *(blocked on Wave 7 completion)*

- [ ] 01-11 — Create the narrow portrait-only iOS candidate device-proof seed and AR session policies.

**Wave 9** *(blocked on Wave 8 completion)*

- [ ] 01-12 — Implement orientation, epoch correction/quarantine, and atomic FramePacket capture.

**Wave 10** *(blocked on Wave 9 completion)*

- [ ] 01-13 — Add sanitized internal diagnostics and prove shipping UI exclusion.

**Wave 11** *(blocked on Wave 10 completion)*

- [ ] 01-14 — Run automated preflight, obtain real signed GATE-013/GATE-002 evidence, and promote the candidate only on GATE-013 GREEN.
...
|-------|----------------|--------|-----------|
| 1. Contract and Device Proof | 0/14 | Not started | - |

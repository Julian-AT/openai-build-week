...
let package = Package(
    ...
    products: [
        ...
        .executable(name: "ReRoomTransactionTraceExporter", targets: ["ReRoomTransactionTraceExporter"]),
    ],
    dependencies: [
        .package(
    ...
    targets: [
        ...
        .executableTarget(
            name: "ReRoomTransactionTraceExporter",
            dependencies: ["ReRoomContracts", "ReRoomCaptureCore", "ReRoomTransactionCore"]
        ),
        .testTarget(
